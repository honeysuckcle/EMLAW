...
parser.add_argument('--target_known_data', type=str,
                    default='./utils/target_list.txt',
                    help='path to target list')
parser.add_argument('--target_unknown_data', type=str,
                    default='./utils/target_list.txt',
                    help='path to target list')
...
parser.add_argument('--n_source_private', type=int,
                    default=0,
                    help='number of classes in source private domain')
...
n_unknown = conf.data.dataset.n_unknown
open = n_unknown > 0
...
inputs["share_n"], inputs["private_source_n"] = n_share, n_source_private
