...
parser.add_argument('--aug_source', type=bool,
                    default=False,
                    help='use augmentation for source')
parser.add_argument('--aug_target_train', type=bool, default=False,
                    help='use augmentation for target train')
parser.add_argument('--aug_target_test', type=bool, default=False,
